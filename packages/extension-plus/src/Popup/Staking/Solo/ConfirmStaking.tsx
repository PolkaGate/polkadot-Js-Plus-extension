 ...
 * */
 ...
 export default function ConfirmStaking({ amount, api, chain, handleEasyStakingModalClose, ledger, nominatedValidators, putInFrontInfo, rebagInfo, selectedValidators, setConfirmStakingModalOpen, setSelectValidatorsModalOpen, setState, showConfirmStakingModal, staker, stakingConsts, state, validatorsIdentities }: Props): React.ReactElement<Props> {
   ...
   }, [surAmount, currentlyStaked, api, state, staker.address, bonding, bondExtra, unbonded, chilled, selectedValidatorsAccountId, nominatedValidatorsId, nominated, redeem, decimals, rebagInfo, putInFrontInfo?.shouldPutInFront, putInFrontInfo?.lighter, rebaged, putInFrontOf]);
   ...
   useEffect(() => {
     ...
     !estimatedFee && setFee();
   }, [api, confirmingState, currentlyStaked, decimals, estimatedFee, setFee]);
