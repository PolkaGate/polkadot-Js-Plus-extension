...
interface Props {
  ...
  poolInfo: any | undefined;
  staker: AccountsBalanceType;
  memberInfo: PalletNominationPoolsPoolMember | undefined;
}

export default function Pool({ api, chain, poolInfo, staker }: Props): React.ReactElement<Props> {
